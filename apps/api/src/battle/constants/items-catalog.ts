...
export const ITEMS_CATALOG: ItemDef[] = [
    ...
    },
    {
        ...
        category: 'POTION',
        effect: { type: 'HEAL_HP', value: 0.50, isPercentage: true },
        rarity: 'UNCOMMON',
        maxStack: 3,
    },
    {
        ...
        category: 'POTION',
        effect: { type: 'HEAL_MANA', value: 0.30, isPercentage: true },
        rarity: 'COMMON',
        maxStack: 5,
    },
    {
        ...
        category: 'POTION',
        effect: { type: 'HEAL_MANA', value: 0.60, isPercentage: true },
        rarity: 'UNCOMMON',
        maxStack: 3,
    },
    ...
    // ─── Buff Items ───────────────────────────────────────────────────────
    {
        ...
        category: 'BUFF',
        effect: { type: 'BUFF_ATK', value: 0.20, duration: 3 },
        rarity: 'UNCOMMON',
        maxStack: 3,
    },
    {
